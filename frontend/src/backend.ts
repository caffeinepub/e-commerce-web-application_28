...
import type { Category as _Category, Order as _Order, OrderItem as _OrderItem, Product as _Product, Status as _Status, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createProduct(arg0: string, arg1: string, arg2: Category, arg3: bigint, arg4: bigint, arg5: {
        url: string;
        name: string;
        mimeType: string;
    }): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.createProduct(arg0, arg1, to_candid_Category_n10(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5);
    ...
    async updateOrderStatus(arg0: bigint, arg1: Status): Promise<Order> {
        if (this.processError) {
            try {
                const result = await this.actor.updateOrderStatus(arg0, to_candid_Status_n25(this._uploadFile, this._downloadFile, arg1));
                return from_candid_Order_n19(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: Category, arg4: bigint, arg5: bigint, arg6: {
        url: string;
        name: string;
        mimeType: string;
    }): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, arg1, arg2, to_candid_Category_n10(this._uploadFile, this._downloadFile, arg3), arg4, arg5, arg6);
                return from_candid_Product_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "clothing" in value ? Category.clothing : "homeKitchen" in value ? Category.homeKitchen : "electronics" in value ? Category.electronics : value;
}
...
function from_candid_variant_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "shipped" in value ? Status.shipped : "cancelled" in value ? Status.cancelled : "pending" in value ? Status.pending : "delivered" in value ? Status.delivered : "processing" in value ? Status.processing : value;
}
